          ...
          <swiper-slide v-for="(food, index) in foodPhotoEach"
            ...
            <div class="card h-100" style="background-color: transparent;">
                <div style="overflow: hidden; display: flex; align-items: center; justify-content: center;">
                  ...
                  class="card-img-top"
                  style="object-fit: cover; width: 700px; height: 400px; border-radius: 5px;"
                  alt="..."
                  />
                </div>
                <div class="card-body text-white">

                  <h5 class="card-title" style="width: 100%;color: #F5811C;"><div style="width: 100%;" class="d-flex justify-content-between"><p class="text-start">{{ food.titulo }}</p> <p class="text-end">{{ food.precio }}</p></div></h5>
                  <p class="card-text multiline-content">{{ food.descripcion }}</p>
